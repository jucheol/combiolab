...
//			Taxon taxon = Taxon.getTaxon(taxonPrefix + Integer.toString(i + 1) + "_" + Double.toString(samplingTimes[i]));
			Taxon taxon = Taxon.getTaxon(taxonPrefix + "_" + Integer.toString(i + 1));
...
//				Taxon taxon = Taxon.getTaxon(taxonPrefix + Integer.toString(k + 1) + "_" + Double.toString(samplingTimes[i]));		//original
				Taxon taxon = Taxon.getTaxon(taxonPrefix + "_" +Integer.toString(k + 1));
				taxon.setAttribute("height", samplingTimes[i]);
				taxonList.add(taxon);
				k++;
			}
